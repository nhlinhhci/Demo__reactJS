      ...
      return (
        <div className="col-4 pb-3" key={index}>
          <div className="card">
            <div
              style={{
                background: `url('${product.hinhAnh}')`,
            ...
            <div className="card-body">
              <h4 style={{ height: "50px" }} className="card-title">
                {product.tenPhim.length > 8 ? (
                  //Làm tên phim và mô tả phim ... khi vượt quá số lượng kí tự
                  <span>{product.tenPhim.substring(0, 8)}...</span>
                ) : (
                  <span>{product.tenPhim}</span>
                )}
              </h4>
              <p style={{ height: "150px" }} className="card-text">
                {product.moTa.length > 100 ? (
                  <span>{product.moTa.substring(0, 100)}...</span>
                ) : (
  ...
  render() {
    return (
      <div className="container">
        <h1 className="text-red">Danh sách phim</h1>
        <div className="row">{this.renderListPhim()}</div>
      </div>
    );
  }
}
